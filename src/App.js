...
},
{
    ...
    description: "It has a preferencia for hot things. When it rans, steam is said to spout from the tip of its tail.",
    hp: "039",
    atk: "052",
    def: "043",
    satk: "060",
...
},
{
    ...
    description: "In battle, it flops its wings at greta speed to release highly toxic dust into the air.",
    hp: "060",
    atk: "045",
    def: "050",
    satk: "090",
...
},
{
    ...
    heigth: 1.3,
    moves: ["Levitate"],
    description: "Born form gases, anyone would faint if engulled by its gaseous body, which contains poison.",
    hp: "030",
    atk: "035",
    def: "030",
    satk: "100",
...
},
{
  ...
  return (
    <div className="App">
      {pokemon.map((pokemon) => <PokemonBox name={pokemon.name} id={pokemon.id} img={pokemon.img} primary_color={pokemon.primary_color}/>)}
    </div>
  );
}
